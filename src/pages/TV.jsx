import davidSm from "../assets/tv/tv-david.png"
import davidMd from "../assets/tv/tv-david-md.png"
import davidXL from "../assets/tv/tv-david-xl.png"
...
const TV = () => {
    ...
    return (
        <div>
            <Hero
                images={hero1}
                heading="david makes man: season 2"
                subheading="premiering june 22 at 9/8c on OWN"
                official
            />

            <div className="pt-8 pb-4 space-y-8 bg-white">
                {/* In Theaters */}
                <Content items={inTheaters} heading="New series" />
                {/* Movie & TV Favorites */}
                <Content items={movieTV} heading="returning series" />
            </div>
        </div>
    )
}
