import davidSm from "../assets/games/dc.png"
import davidMd from "../assets/games/dc-tablet.png"
import davidXL from "../assets/games/dc-desktop.png"
...
const Games = () => {
    ...
    return (
        <div>
            <Hero
                images={hero1}
                heading="DC universe infinite"
                subheading="explore the multiverse"
                join
            />

            <div className="pt-8 pb-4 space-y-8 bg-white">
                {/* In Theaters */}
                <Content items={inTheaters} heading="video games" />
                {/* Movie & TV Favorites */}
                <Content items={movieTV} heading="mobile games & apps" />
            </div>
        </div>
    )
}
