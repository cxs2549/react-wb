import hero from "../assets/hero/heights.png"
import heroMd from "../assets/hero/heights-md.png"
import heroXL from "../assets/hero/heights-xl.png"
...
import sudden from "../assets/hero/sudden.png"
import suddenMd from "../assets/hero/sudden-md.png"
import suddenXL from "../assets/hero/sudden-xl.png"
...
const Home = () => {
    ...
    return (
        <div>
            <Hero
                images={hero1}
                heading="in the heights"
                subheading="now in theaters and on HBO max"
                getTickets
                hbo
            />
                ...
                <div className="pt-8 pb-4 space-y-8 bg-white">
                    {/* In Theaters */}
                    <Content items={inTheaters} heading="In Theaters and on HBO Max" />
                    {/* Movie & TV Favorites */}
                    <Content items={movieTV} heading="movie & TV favorites" />
                </div>
           

            <Hero
                images={hero2}
                heading="no sudden move"
                subheading="streaming on HBO max july 1"
                hbo
            />
        </div>
    )
